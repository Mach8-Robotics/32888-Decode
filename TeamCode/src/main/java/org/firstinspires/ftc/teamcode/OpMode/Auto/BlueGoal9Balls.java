...
@Autonomous( name= "Blue Goal 9 balls", group ="Blue")
public class BlueGoal9Balls extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path15= new Path(new BezierCurve(new Pose(36.000, 36.000), new Pose(36.000, 72.000)));

...
public class BlueGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path7 = new Path(new BezierCurve(new Pose(18.000, 64.000), new Pose(48.000, 64.000)));
        path7.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path8 = new Path(new BezierCurve(new Pose(48.000, 64.000), new Pose(48.000, 96.000)));

...
public class BlueGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path6a = new Path(new BezierCurve(new Pose(36.000, 84.000), new Pose(36.000, 72.000)));
        path6a.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path6b = new Path(new BezierCurve(new Pose(36.000, 72.000), new Pose(20.000, 72.000)));
        path6b.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path6c = new Path(new BezierCurve(new Pose(20.000, 72.000), new Pose(36.000, 72.000)));

...
public class BlueGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path3 = new Path(new BezierCurve(new Pose(48.000,60.000), new Pose(12.000, 55.000)));
        path3.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path4 = new Path(new BezierCurve(new Pose(12.000, 55.000), new Pose(36.000, 60.000)));
        path4.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path5 = new Path(new BezierCurve(new Pose(36.000, 60.000), new Pose(36.000, 64.000)));
        path5.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path6 = new Path(new BezierCurve(new Pose(36.000, 64.000), new Pose(18.000, 64.000)));
        path6.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path7 = new Path(new BezierCurve(new Pose(18.000, 64.000), new Pose(48.000, 75.000)));

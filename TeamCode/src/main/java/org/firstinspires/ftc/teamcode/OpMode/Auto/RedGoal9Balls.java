...
@Autonomous( name= "Red Goal 9 Balls", group ="Red")
public class RedGoal9Balls extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path15= new Path(new BezierCurve(new Pose(36.000, 36.000).mirror(), new Pose(36.000, 72.000).mirror()));

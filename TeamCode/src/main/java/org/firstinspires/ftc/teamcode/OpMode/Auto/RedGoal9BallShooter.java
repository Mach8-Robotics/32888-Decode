...
public class RedGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path3 = new Path(new BezierCurve(new Pose(48.000,60.000).mirror(), new Pose(12.000, 60.000).mirror()));
        path3.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path4 = new Path(new BezierCurve(new Pose(12.000, 60.000).mirror(), new Pose(36.000, 60.000).mirror()));
        path4.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path5 = new Path(new BezierCurve(new Pose(36.000, 60.000).mirror(), new Pose(36.000, 75.000).mirror()));
        path5.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path6 = new Path(new BezierCurve(new Pose(36.000, 75.000).mirror(), new Pose(18.000, 75.000).mirror()));
        path6.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path7 = new Path(new BezierCurve(new Pose(18.000, 75.000).mirror(), new Pose(48.000, 75.000).mirror()));
        path7.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path8 = new Path(new BezierCurve(new Pose(48.000, 75.000).mirror(), new Pose(48.000, 96.000).mirror()));
        path8.setLinearHeadingInterpolation(Math.toRadians(36), Math.toRadians(36));
        path9 = new Path(new BezierCurve(new Pose(48.000, 96.000).mirror(), new Pose(26.000, 120.000).mirror()));
        path9.setLinearHeadingInterpolation(Math.toRadians(36), Math.toRadians(36));
        path10 = new Path(new BezierCurve(new Pose(26.000, 120.000).mirror(), new Pose(48.000, 96.000).mirror()));  //x(36)Changes for next Config
        path10.setLinearHeadingInterpolation(Math.toRadians(36), Math.toRadians(36));
        path11= new Path(new BezierCurve(new Pose(48.000, 96.000).mirror(), new Pose(48.000, 84.000).mirror()));
        path11.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path12= new Path(new BezierCurve(new Pose(48.000, 84.000).mirror(), new Pose(18.000, 84.000).mirror()));
        path12.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path13= new Path(new BezierCurve(new Pose(18.000, 84.000).mirror(), new Pose(36.000, 84.000).mirror()));
        path13.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path14= new Path(new BezierCurve(new Pose(36.000, 84.000).mirror(), new Pose(36.000, 108.000).mirror()));
        path14.setLinearHeadingInterpolation(Math.toRadians(36), Math.toRadians(36));
        path15= new Path(new BezierCurve(new Pose(36.000, 108.000).mirror(), new Pose(26.000, 120.000).mirror()));
        path15.setLinearHeadingInterpolation(Math.toRadians(36), Math.toRadians(36));
        path16= new Path(new BezierCurve(new Pose(26.000, 120.000).mirror(), new Pose(36.000, 108.000).mirror()));
        path16.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path17= new Path(new BezierCurve(new Pose(36.000, 108.000).mirror(), new Pose(36.000, 75.000).mirror()));
        path17.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
    }

...
public class RedGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path5 = new Path(new BezierCurve(new Pose(36.000, 60.000).mirror(), new Pose(36.000, 64.000).mirror()));
        path5.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path6 = new Path(new BezierCurve(new Pose(36.000, 64.000).mirror(), new Pose(18.000, 64.000).mirror()));
        path6.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path7 = new Path(new BezierCurve(new Pose(18.000, 64.000).mirror(), new Pose(48.000, 64.000).mirror()));
        path7.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path8 = new Path(new BezierCurve(new Pose(48.000, 64.000).mirror(), new Pose(48.000, 96.000).mirror()));

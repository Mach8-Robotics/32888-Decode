...
public class RedGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path6a = new Path(new BezierCurve(new Pose(36.000, 84.000).mirror(), new Pose(36.000, 75.000).mirror()));
        path6a.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path6b = new Path(new BezierCurve(new Pose(36.000, 75.000).mirror(), new Pose(19.000, 75.000).mirror()));
        path6b.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path6c = new Path(new BezierCurve(new Pose(19.000, 75.000).mirror(), new Pose(36.000, 75.000).mirror()));

...
public class RedGoal9BallShooter extends AutoBase{
    ...
    public void buildpaths() {
        ...
        path6 = new Path(new BezierCurve(new Pose(36.000, 72.000).mirror(), new Pose(36.000, 108.000).mirror()));
        path6.setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0));
        path6a = new Path(new BezierCurve(new Pose(36.000, 84.000).mirror(), new Pose(36.000, 72.000).mirror()));
        path6a.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path6b = new Path(new BezierCurve(new Pose(36.000, 72.000).mirror(), new Pose(20.000, 72.000).mirror()));
        path6b.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        path6c = new Path(new BezierCurve(new Pose(20.000, 72.000).mirror(), new Pose(36.000, 72.000).mirror()));
        path6c.setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180));
        ...
        path15= new Path(new BezierCurve(new Pose(48.000, 96.000).mirror(), new Pose(36.000, 72.000).mirror()));
